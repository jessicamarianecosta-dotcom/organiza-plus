...
const TEMPLATES: ProfessionTemplate[] = [
  // ── PSICÓLOGO ────────────────────────────────────────────────────────────
  {
    ...
    hero: {
      ...
      sub: 'Atendimento acolhedor e profissional para ajudar você a viver com mais leveza e equilíbrio.',
  ...
  // ── PSIQUIATRA ────────────────────────────────────────────────────────────
  {
    ...
    hero: {
      headline: 'Cuidar da mente também é cuidar da qualidade de vida.',
      sub: 'Atendimento profissional e humanizado para promover equilíbrio emocional e bem-estar.',
  ...
  // ── NUTRICIONISTA ─────────────────────────────────────────────────────────
  {
    ...
    hero: {
      headline: 'Transforme sua alimentação e cuide melhor da sua saúde.',
      sub: 'Atendimento personalizado para ajudar você a alcançar resultados de forma leve, saudável e sustentável.',
      cta: 'Agendar consulta',
  ...
  // ── FISIOTERAPEUTA ────────────────────────────────────────────────────────
  {
    ...
    hero: {
      headline: 'Movimento, recuperação e qualidade de vida para o seu dia a dia.',
      sub: 'Atendimento personalizado para ajudar na sua reabilitação, mobilidade e bem-estar físico.',
      cta: 'Agendar avaliação',
  ...
  // ── MÉDICO ────────────────────────────────────────────────────────────────
  {
    ...
    hero: {
      headline: 'Cuidado profissional para sua saúde e bem-estar.',
      sub: 'Atendimento humanizado e personalizado para acompanhar você em cada etapa do seu cuidado.',
      cta: 'Agendar consulta',
  ...
  // ── DENTISTA ──────────────────────────────────────────────────────────────
  {
    ...
    hero: {
      headline: 'Seu sorriso merece cuidado, confiança e excelência.',
      sub: 'Atendimento profissional e humanizado para cuidar da sua saúde bucal com conforto e segurança.',
      cta: 'Agendar consulta',
  ...
  // ── ESTETICISTA ───────────────────────────────────────────────────────────
  {
    ...
    hero: {
      headline: 'Realce sua beleza e fortaleça sua autoestima.',
      sub: 'Procedimentos estéticos com atendimento premium para você se sentir ainda melhor consigo mesma.',
  ...
  // ── TERAPEUTA ─────────────────────────────────────────────────────────────
  {
    ...
    hero: {
      headline: 'Um espaço de acolhimento, equilíbrio e reconexão.',
      sub: 'Atendimento voltado ao desenvolvimento emocional, energético e bem-estar integral.',
      cta: 'Agendar sessão',
  ...
  // ── COACH ─────────────────────────────────────────────────────────────────
  {
    ...
    hero: {
      headline: 'Desenvolva seu potencial e alcance novos resultados.',
      sub: 'Acompanhamento estratégico para ajudar você a evoluir com clareza, foco e direção.',
  ...
  // ── EDUCADOR FÍSICO / PERSONAL ───────────────────────────────────────────
  {
    ...
    hero: {
      headline: 'Evolua sua saúde, performance e qualidade de vida.',
      sub: 'Treinamentos personalizados para ajudar você a alcançar seus objetivos com acompanhamento profissional.',
      cta: 'Agendar avaliação',
  ...
  // ── GENERIC (fallback) ────────────────────────────────────────────────────
  {
    ...
    keywords: [],
    hero: {
      headline: 'Um atendimento profissional pensado para você.',
      sub: 'Conecte-se com seus clientes de forma moderna, profissional e acolhedora.',
      cta: 'Agendar consulta',
